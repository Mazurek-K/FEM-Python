...
# plot_output(res,10)
animate_static_v2(res, max_scale=30, save_as="results/Static.mp4")

animate_modal(res_modal,0, 50, save_as="results/Mode_1.mp4")
animate_modal(res_modal,3,50, save_as="results/Mode_4.mp4")
